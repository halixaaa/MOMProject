...
public class MeetingController implements IMeetingController{
    ...
    public String insert(String name, String project, String dates, String time, String type, String customer, String manager, String pic) {
        ...
        Meeting meeting = new Meeting(name, project, newDate, time, type, new Customer(new BigDecimal(customer)), new Employee(new BigDecimal(pic)), new Employee(new BigDecimal(manager)));
        if(iGenericDAO.insert(meeting)){
