...
public class FollowupController implements IFollowupController{
    ...
    @Override
    public String insert(String name, String pic, String targetdate, String notes, String mom) {
        String result = "";
        ...
        Followup followup = new Followup(name, pic, newDate, notes, newMom);
        if(iGenericDAO.insert(followup)){
    ...
    @Override
    public String update(String id, String name, String pic, String targetdate, String notes, String mom) {
        String result = "";
        Mom newMom = new Mom(new BigDecimal(mom));
        DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        Date newDate = null;
        ...
        if(iGenericDAO.update(followup)){
            result = "Data berhasil disimpan";
        }else{
            result = "Maaf Data gagal disimpan";
        }
